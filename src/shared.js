...
export const makeXRotationMatrix = function (matrix, angle) {
  matrix[0] = 1.0;
  matrix[1] = 0.0;
  matrix[2] = 0.0;
  matrix[3] = 0.0;
...
export const makeYRotationMatrix = function (matrix, angle) {
...
export const distanceBetweenVectors = function (a, b) {
  const xDist = b[0] - a[0],
    yDist = b[1] - a[1],
    zDist = b[2] - a[2];
...
export const lengthOfVector = function (v) {
  const x = v[0],
    y = v[1],
    z = v[2];
...
export const setVector4 = function (out, x, y, z, w) {
  out[0] = x;
  out[1] = y;
  out[2] = z;
  out[3] = w;
...
export const projectVector4 = function (out, v) {
...
export const transformVectorByMatrix = function (out, v, m) {
  const x = v[0],
    y = v[1],
    z = v[2],
    w = v[3];
...
export const invertMatrix = function (out, m) {
  const m0 = m[0],
    m4 = m[4],
    m8 = m[8],
    m12 = m[12],
...
export const premultiplyMatrix = function (out, matrixA, matrixB) {
  let b0 = matrixB[0],
    b4 = matrixB[4],
    b8 = matrixB[8],
    b12 = matrixB[12],
...
export const makePerspectiveMatrix = function (matrix, fov, aspect, near, far) {
